...
extern "C" {
    pub fn VSIGetCanonicalFilename(pszPath: *const libc::c_char) -> *mut libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn VSICopyFile(
        ...
        fpSource: *mut VSILFILE,
        nSourceSize: vsi_l_offset,
        papszOptions: *const *const libc::c_char,
...
extern "C" {
    ...
    pub fn VSIDuplicateFileSystemHandler(
        pszSourceFSName: *const libc::c_char,
        pszNewFSName: *const libc::c_char,
    ) -> bool;
}
extern "C" {
...
fn bindgen_test_layout_VSIFilesystemPluginCallbacksStruct() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).advise_read) as usize - ptr as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(VSIFilesystemPluginCallbacksStruct),
            "::",
            stringify!(advise_read)
        )
    );
}
extern "C" {
...
extern "C" {
    pub fn CPLGetErrorHandler(ppUserData: *mut *mut libc::c_void) -> CPLErrorHandler;
}
extern "C" {
...
extern "C" {
    pub fn CPLUnsubscribeToSetConfigOption(nSubscriberId: libc::c_int);
}
extern "C" {
    #[doc = " @cond Doxygen_Suppress"]
...
extern "C" {
    pub fn CPLAddFileInZip(
        hZip: *mut libc::c_void,
        pszArchiveFilename: *const libc::c_char,
        pszInputFilename: *const libc::c_char,
        fpInput: *mut VSILFILE,
        papszOptions: CSLConstList,
        pProgressFunc: GDALProgressFunc,
        pProgressData: *mut libc::c_void,
    ) -> CPLErr::Type;
...
extern "C" {
    pub fn OGR_Fld_GetTZFlag(arg1: OGRFieldDefnH) -> libc::c_int;
}
extern "C" {
    pub fn OGR_Fld_SetTZFlag(arg1: OGRFieldDefnH, arg2: libc::c_int);
}
extern "C" {
    pub fn OGR_Fld_Set(
        arg1: OGRFieldDefnH,
...
extern "C" {
    pub fn OGR_Fld_GetComment(hDefn: OGRFieldDefnH) -> *const libc::c_char;
}
extern "C" {
    pub fn OGR_Fld_SetComment(hDefn: OGRFieldDefnH, arg1: *const libc::c_char);
}
extern "C" {
...
extern "C" {
    pub fn OGR_F_DumpReadableAsString(arg1: OGRFeatureH, arg2: CSLConstList) -> *mut libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn OGR_L_IsArrowSchemaSupported(
        ...
        papszOptions: *mut *mut libc::c_char,
        ppszErrorMsg: *mut *mut libc::c_char,
    ) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn OGR_L_UpdateFeature(
        arg1: OGRLayerH,
        arg2: OGRFeatureH,
        nUpdatedFieldsCount: libc::c_int,
        panUpdatedFieldsIdx: *const libc::c_int,
        nUpdatedGeomFieldsCount: libc::c_int,
        panUpdatedGeomFieldsIdx: *const libc::c_int,
...
extern "C" {
    pub fn GDALRegisterPlugin(name: *const libc::c_char) -> CPLErr::Type;
}
extern "C" {
    pub fn GDALCreate(
        hDriver: GDALDriverH,
...
extern "C" {
    pub fn GDALDatasetReadCompressedData(
        ...
        nBandCount: libc::c_int,
        panBandList: *const libc::c_int,
        ppBuffer: *mut *mut libc::c_void,
        pnBufferSize: *mut usize,
        ppszDetailedFormat: *mut *mut libc::c_char,
    ) -> CPLErr::Type;
}
extern "C" {
...
pub type GDALQueryLoggerFunc = ::std::option::Option<
    unsafe extern "C" fn(
        pszSQL: *const libc::c_char,
        pszError: *const libc::c_char,
        lNumRecords: i64,
        lExecutionTimeMilliseconds: i64,
        pQueryLoggerArg: *mut libc::c_void,
    ),
>;
extern "C" {
    ...
    pub fn GDALDatasetSetQueryLoggerFunc(
        ...
        poQueryLoggerArg: *mut libc::c_void,
    ) -> bool;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = "  Opaque type used for the C bindings of the C++ GDALSubdatasetInfo class\n  @since GDAL 3.8"]
...
extern "C" {
    ...
    pub fn GDALGetSubdatasetInfo(pszFileName: *const libc::c_char) -> GDALSubdatasetInfoH;
}
extern "C" {
    ...
    pub fn GDALSubdatasetInfoGetPathComponent(hInfo: GDALSubdatasetInfoH) -> *mut libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn GDALGroupRename(hGroup: GDALGroupH, pszNewName: *const libc::c_char) -> bool;
}
extern "C" {
    pub fn GDALGroupSubsetDimensionFromSelection(
        hGroup: GDALGroupH,
        pszSelection: *const libc::c_char,
        papszOptions: CSLConstList,
    ) -> GDALGroupH;
}
extern "C" {
...
extern "C" {
    pub fn GDALMDArrayGetGridded(
        hArray: GDALMDArrayH,
        pszGridOptions: *const libc::c_char,
        hXArray: GDALMDArrayH,
        hYArray: GDALMDArrayH,
        papszOptions: CSLConstList,
    ) -> GDALMDArrayH;
}
extern "C" {
...
extern "C" {
    pub fn GDALMDArrayRename(hArray: GDALMDArrayH, pszNewName: *const libc::c_char) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn GDALAttributeRename(hAttr: GDALAttributeH, pszNewName: *const libc::c_char) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn GDALDimensionRename(hDim: GDALDimensionH, pszNewName: *const libc::c_char) -> bool;
}
extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GDALVectorInfoOptions {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub fn OSRHasPointMotionOperation(arg1: OGRSpatialReferenceH) -> libc::c_int;
}
extern "C" {
...
#[doc = " Data type for a Arrow C schema. Include ogr_recordbatch.h to get the\n definition."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ArrowSchema {
    pub format: *const libc::c_char,
    pub name: *const libc::c_char,
    pub metadata: *const libc::c_char,
    pub flags: i64,
    pub n_children: i64,
...
#[doc = " Data type for a Arrow C array. Include ogr_recordbatch.h to get the\n definition."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ArrowArray {
    ...
    pub n_buffers: i64,
    pub n_children: i64,
    pub buffers: *mut *const libc::c_void,
